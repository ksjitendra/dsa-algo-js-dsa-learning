...
//www.youtube.com/watch?v=75W8UPQ5l7k&ab_channel=AkshaySaini

var newObj = tetttt.printFullName(firstname);
...
// Apply method
printFullName.apply(name, ["Dehradun", "Uttadddddrakhand"]);

// Bind method
// it just bind the method and keep the copy and can use it later
let printMyname = printFullName.bind(name, "Dehradun", "Uttahhhhrakhand");
